...
// import HistoryRecord from "../app/pannels/candidate/compon";
...
import HistoryRecord from "../app/pannels/candidate/components/history-record";
...
function CandidateRoutes() {
  return (
    <Routes>
      ...
      <Route path={candidate.HISTORY} element={<HistoryRecord />} />
