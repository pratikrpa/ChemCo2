  ...
  return (
    <>
      <header className={"site-header " + _config.style}>
        ...
        <div
          className={"twm-side-navigation-menu " + (menuActive ? "active" : "")}
        >
          <div className="nav-sidebar-wrap  scrollbar-macosx">
            <a
              href="#"
              className="vnav-close"
              onClick={handleNavigationClick}
            />
            <ul className="nav ">
              ...
              <li className="has-child">
                ...
                <ul className="sub-menu">
                  ...
                  <li className="has-child">
                    ...
                    <ul className="sub-menu">
                      <li>
                        <NavLink to={publicUser.jobs.DETAIL1}>Detail 1</NavLink>
                      </li>
                      <li>
              ...
              <li className="has-child">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <NavLink to={publicUser.pages.ERROR404}>Error-404</NavLink>
                  </li>
                  <li>
                    <NavLink to={publicUser.pages.FAQ}>FAQ's</NavLink>
                  </li>
                  <li>
                    <NavLink to={publicUser.pages.CONTACT}>Contact Us</NavLink>
                  </li>
                  <li>
                  ...
                  <li>
                    <NavLink to={publicUser.pages.COMING}>Coming soon</NavLink>
                  </li>
                  <li>
              ...
              <li className="has-child">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <NavLink to={publicUser.blog.GRID3}>Blog Grid-2</NavLink>
                  </li>
                  <li>
                    <NavLink to={publicUser.blog.LIST}>Blog List</NavLink>
                  </li>
                  <li>
                    <NavLink to={publicUser.blog.DETAIL}>Blog Detail</NavLink>
                  </li>
                </ul>
              </li>
            </ul>
