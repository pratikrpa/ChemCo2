...
export const banner = {
  publicUser: {
    ...
    pages: {
      ...
      inputformoutput: {
        title: "Input Form Output",
        crumb: "Input Form Output",
      },
      icons: {
        title: "Icons",
        crumb: "Icons",
...
export function showBanner(currentpath) {
  if (
    currentpath === publicUser.INITIAL ||
...
export function setBanner(currentpath) {
  switch (currentpath) {
    ...
    case pubRoute(publicUser.pages.INPUTFORM): {
      return banner.publicUser.pages.inputform;
    }
    case pubRoute(publicUser.pages.INPUTFORMOUTPUT): {
      return banner.publicUser.pages.inputformoutput;
    }
    ...
    case canRoute(candidate.HISTORY): {
      return banner.candidate.history;
    }
