...
export function updateSkinStyle(skin, headerLogoLight, footerLogoLight) {
    ...
    const _logo = publicUrlFor("/ChemCo2-Logo-Green-PNG.png");
    const _logo_light = publicUrlFor("/ChemCo2-Logo-Green-PNG.png");
    const _logo_white = publicUrlFor("/ChemCo2-Logo-Green-PNG.png");
    ...
    if (_skin_footer_dark_logo)
        _skin_footer_dark_logo.src = footerLogoLight ? _logo_white : publicUrlFor('/ChemCo2-Logo-Green-PNG.png');
    ...
    if (_skin_maintain_logo)
        _skin_maintain_logo.src = publicUrlFor('/ChemCo2-Logo-Green-PNG.png');

    if (_skin_header_inner_logo_12)
        _skin_header_inner_logo_12.src = publicUrlFor('/ChemCo2-Logo-Green-PNG.png');

    if (_skin_header_inner_logo_15)
        _skin_header_inner_logo_15.src = publicUrlFor('/ChemCo2-Logo-Green-PNG.png');
}